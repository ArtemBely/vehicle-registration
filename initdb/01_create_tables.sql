...
ALTER SEQUENCE public.customer_id_seq1 OWNED BY public.customer.id;
...
CREATE TABLE public.factory (
    ...
    factory_location character varying(30) NOT NULL,
    director_id character varying(200) NOT NULL
);
...
CREATE TABLE public.vehicle (
    id integer NOT NULL,
    carserie character varying(30) NOT NULL,
    carbody character varying(30) NOT NULL,
    motor character varying(30) NOT NULL,
    transmission character varying(30) NOT NULL,
    werk character varying(30) NOT NULL,
    baugruppe character varying(30) NOT NULL,
    knr7 integer NOT NULL,
    pin13 bigint NOT NULL,
...
ALTER TABLE ONLY public.customer ALTER COLUMN id SET DEFAULT nextval('public.customer_id_seq1'::regclass);
...
--
-- Name: vehicle vehicle_factory_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.vehicle
    ADD CONSTRAINT vehicle_factory_id_fkey FOREIGN KEY (factory_id) REFERENCES public.factory(id);
